      ...
      <section className='w-full py-10'>
        ...
        <div>
          <div className='w-[90%] mx-auto py-20 grid lg:grid-cols-2 justify-center items-center gap-12'>
            <div className='w-full h-full flex flex-col justify-center'>
              <h1>Message Sequences</h1>
              <p className='text-justify text-gray-600 mb-4'>Nurture leads and customers with automated follow-up sequences. Send the right message at the right time, every time—without lifting a finger.</p>
        ...
        <div className='bg-[#f9f9f9]'>
          <div className='w-[90%] mx-auto py-20 flex flex-col gap-12'>
            <div className='text-center h-fit'>
              <h2>Automation That Converts</h2>
        ...
        <div>
          <div className='w-[90%] mx-auto py-20 grid lg:grid-cols-2 gap-12 items-center'>
            <div className='w-full h-full flex flex-col justify-center'>
              <h2>Sophisticated Yet Simple</h2>
              <p className='text-justify text-gray-600 mb-4'>Build complex automation with our intuitive sequence builder. No technical skills required.</p>
        ...
        <div className='bg-[#f9f9f9]'>
          <div className='w-[90%] mx-auto py-20 flex flex-col gap-12'>
            <div className='text-center h-fit'>
              <h2>Sequences for Every Goal</h2>
              <p className='text-gray-600'>From lead nurturing to customer retention, sequences handle it all.</p>
            </div>
