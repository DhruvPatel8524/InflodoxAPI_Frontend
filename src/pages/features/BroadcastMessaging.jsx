      ...
      <section className='w-full py-10'>
        ...
        <div>
          <div className='w-[90%] mx-auto py-20 grid lg:grid-cols-2 justify-center items-center gap-12'>
            <div className='w-full h-full flex flex-col justify-center'>
              ...
              <p className='text-justify text-gray-600 mb-4'>Reach thousands of customers instantly with personalized announcements, promotions, and updates. Send the right message to the right people at the right time.</p>
        ...
        <div className='bg-[#f9f9f9]'>
          <div className='w-[90%] mx-auto py-20 flex flex-col gap-12'>
            <div className='text-center h-fit'>
              <h2>Why Businesses Love Broadcast Messaging</h2>
              <p className='text-gray-600'>Save time, reach more customers, and drive real results with powerful broadcast capabilities.</p>
            </div>
        ...
        <div>
          <div className='w-[90%] mx-auto py-20 grid lg:grid-cols-2 gap-12 items-center'>
            <div className='w-full h-full flex flex-col justify-center'>
              <h2>Everything You Need for Effective Broadcasts</h2>
              <p className='text-justify text-gray-600 mb-4'>From personalization to analytics, our broadcast messaging feature has everything you need to communicate at scale.</p>
        ...
        <div className='bg-[#f9f9f9]'>
          <div className='w-[90%] mx-auto py-20 flex flex-col gap-12'>
            <div className='text-center h-fit'>
              <h2>Use Cases</h2>
              <p className='text-gray-600'>See how businesses are using broadcast messaging to grow.</p>
            </div>
